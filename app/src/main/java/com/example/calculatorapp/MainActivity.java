...
public class MainActivity extends AppCompatActivity {
    ...
    private void viewSetup() {
        ...
        b_equal = findViewById(R.id.button_equals);
        b_multi = findViewById(R.id.button_multiplication);
        b_divide = findViewById(R.id.button_division);
        b_add = findViewById(R.id.button_addition);
        b_sub = findViewById(R.id.button_subtraction);
        b_clear = findViewById(R.id.button_clear);
        b_dot = findViewById(R.id.button_dot);
        b_para1 = findViewById(R.id.button_modulas);
        b_para2 = findViewById(R.id.button_plusorminus);
